...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Chiron Logo',    group: 'Sidebar' },
...
function _updateFavicon(fg) {
  ...
  if (routeShape) {
    ...
    svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path d='M16 3 L27 8 V16 C27 23 22 27.5 16 29 C10 27.5 5 23 5 16 V8 Z' fill='${fg}'/></svg>`;
  }
