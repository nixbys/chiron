...
function handleVote(winnerIdx) {
  ...
  for (let i = 0; i < state._selectedModels.length; i++) {
    ...
    if (isWinner) html = '<span style="color:var(--green, #22c55e);margin-right:4px;">&#x2605;</span><strong>' + escapeHtml(name) + '</strong> <span style="color:var(--green, #22c55e);font-size:0.82em;font-weight:800;text-transform:uppercase;letter-spacing:1px;position:relative;top:0;">Winner!</span>' + caret;
