...
import { bindMenuDismiss, dismissOrRemove } from './escMenuStack.js';
  ...
  // Inject tab menu styles immediately (must exist before any hover)
  {
    ...
    s.textContent = `.doc-tab-menu-btn{background:none!important;border:none!important;outline:none!important;box-shadow:none!important;color:var(--fg);opacity:0.25;cursor:pointer;padding:2px 4px!important;height:auto!important;line-height:1;transition:opacity .15s;flex-shrink:0;-webkit-appearance:none;appearance:none}.doc-tab-menu-btn:focus,.doc-tab-menu-btn:active{outline:none!important;box-shadow:none!important;background:none!important}.doc-tab:hover .doc-tab-menu-btn{opacity:.5}.doc-tab-menu-btn:hover{opacity:1!important}.doc-tab-dropdown .dropdown-item-compact{padding:6px 8px;border-radius:6px;cursor:pointer;white-space:nowrap;border-bottom:none;display:flex;align-items:center;gap:10px;font-size:11px}.doc-tab-dropdown .dropdown-item-compact:hover{background:color-mix(in srgb,var(--fg) 8%,transparent)}.doc-tab-dropdown .dropdown-item-compact .dropdown-icon{width:14px;height:14px;display:flex;align-items:center;justify-content:center;flex-shrink:0;opacity:0.5}.doc-tab-dropdown .dropdown-divider{height:1px;margin:3px 0;background:color-mix(in srgb,var(--border) 40%,transparent)}.doc-tab-action-delete{color:var(--red,#e5484d)!important}.doc-tab-action-delete .dropdown-icon{opacity:0.7!important}`;
  ...
  async function _attachOdysseusItem(kind, id, label, opts = {}) {
    try {
      ...
      if (uiModule) uiModule.showError('Failed to attach from Chiron');
    }
  }
  ...
  async function _attachSelectedOdysseusItems(menu) {
    ...
    try {
      ...
      _afterOdysseusAttachmentsAdded(added, zip ? 'chiron-attachments.zip' : undefined);
      _closeOdysseusAttachMenu();
    } catch (err) {
      console.error('Failed to attach selected Odysseus items:', err);
      if (uiModule) uiModule.showError(added ? `Attached ${added}, then failed` : 'Failed to attach from Chiron');
      _renderComposeAttachments();
    } finally {
      if (btn) {
    ...
    pane.innerHTML = `
      ...
      <div class="doc-md-toolbar" id="doc-md-toolbar" style="display:none">
        <div class="md-toolbar-items" id="md-toolbar-items">
          ...
          <button type="button" class="md-toolbar-edit-only" data-md="hr" title="Horizontal rule">—</button>
          <span class="md-toolbar-sep md-toolbar-edit-only"></span>
